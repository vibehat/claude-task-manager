...
`;
  ...
  // Scope labels
  const scopeLabels = ['API', 'Gateway', 'Packages', 'Infrastructure', 'Config', 'Docs', 'Tests', 'Dependencies'];
...
`;
  ...
  // Risk labels
  const riskLabels = ['Migration', 'Event', 'Scheduler', 'Subscriber', 'Schema', 'Security', 'Breaking'];
...
`;
  ...
  const processedLabels = new Set([...scopeLabels, ...changeTypeLabels, ...riskLabels, 'MergeBack', 'Release', 'WIP', 'Beta', 'AnyChange']);

        ...
        <CollapsibleTrigger className="w-full p-4 text-left hover:bg-muted/50 transition-colors">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <Badge variant="outline" className={`text-xs ${getStatusColor(subtask.statusId)}`}>
                {subtask.statusId}
              </Badge>
            ...
            <div className="pl-7">
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-4 text-xs text-muted-foreground pt-2 border-t">
                  <span>Created: {format(new Date(subtask.createdAt), 'MMM dd, yyyy')}</span>
                  <span>Updated: {format(new Date(subtask.updatedAt), 'MMM dd, yyyy')}</span>

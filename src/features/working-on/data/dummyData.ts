    ...
    subtasks: [
      {
        ...
        description: 'Implement generateToken() and validateToken() helper functions',
        status: 'done',
        priority: 'high',
        progress: 100,
      ...
      {
        id: '28.2.2',
        title: 'Implement RS256 key management',
        description: 'Set up private/public key pair handling for RS256 algorithm',
        status: 'done',
        priority: 'high',
        progress: 100,
      ...
      },
      {
        ...
        description: 'Create Express middleware for validating JWT tokens on protected routes',
        status: 'in-progress',
        priority: 'high',
        progress: 75,
        estimatedTime: '10 minutes',
        dependencies: ['28.2.1', '28.2.2'],
        blockedTasks: [],
        tags: ['jwt', 'middleware', 'validation'],
        contextQuality: 3,
        createdAt: '2025-01-08T14:30:00Z',
        updatedAt: '2025-01-08T15:48:00Z',
      },
      {
        id: '28.2.4',
        title: 'Write JWT unit tests',
        description: 'Comprehensive test suite for token generation, validation, and error cases',
        status: 'pending',
        priority: 'medium',
        progress: 0,
        estimatedTime: '15 minutes',

            ...
            <div className="max-w-md text-center space-y-4">
               ...
               <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
                     The terminal functionality is not available. Please ensure you&apos;re
                     accessing this page through the proper layout.
                  </p>
               </div>
            </div>
         </div>
         ...
         <div className="flex items-center justify-between mb-6">
            <div>
               ...
               <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                  Create and manage multiple terminal instances for running commands and Task Master
                  CLI
               </p>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center">
               <div className="max-w-md text-center space-y-4">
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400">
                     <p>
                        💡 Pro tip: Create multiple terminals for different tasks - they all stay
                        connected while you navigate between pages
                     </p>
                  </div>
               </div>
            </div>

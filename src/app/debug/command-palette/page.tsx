      ...
      <div className="space-y-6">
        ...
        <div className="p-6 border rounded-lg">
          ...
          <p className="text-sm text-muted-foreground mb-6">
            Click any button to see how the command palette can be opened with pre-selected commands
            and values
          </p>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mb-3">Bug report form with description</p>
              <Button
                variant="outline"
                size="sm"
                className="w-full"
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mb-3">Multi-step workflow example</p>
              <Button
                variant="outline"
                size="sm"
                className="w-full"
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mb-3">Search through project files</p>
              <Button
                variant="outline"
                size="sm"
                className="w-full"
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mb-3">Context-aware search results</p>
              <Button
                variant="outline"
                size="sm"
                className="w-full"
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mb-3">Fully custom result display</p>
              <Button
                variant="outline"
                size="sm"
                className="w-full"
            ...
            <div className="p-4 border rounded-lg">
              ...
              <p className="text-xs text-muted-foreground mb-3">Search with custom grouping</p>
              <Button
                variant="outline"
                size="sm"
                className="w-full"
        ...
        <div className="p-4 border rounded-lg space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Try changing these values and reopening the command palette to see dynamic commands:
          </p>
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => setExternalContext((prev) => ({ ...prev, theme: e.target.value }))}
        ...
        <div className="p-6 border rounded-lg">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside text-xs space-y-1 text-muted-foreground">
                <li>
                  <strong>Search Files</strong> - Search through project files with real-time
                  results
                </li>
                <li>
                  <strong>Search Commands</strong> - Find available commands by name or description
                </li>
                <li>
                  <strong>Dynamic Data Search</strong> - Context-aware search with project-specific
                  results
                </li>
              </ul>
            </div>
            <div className="space-y-2">
              ...
              <ul className="list-disc list-inside text-xs space-y-1 text-muted-foreground">
                <li>
                  <strong>Grid Layout</strong> - Display search results in a responsive grid format
                </li>
                <li>
                  <strong>Table Layout</strong> - Show results in a structured table with multiple
                  columns
                </li>
                <li>
                  <strong>Custom Renderer</strong> - Fully custom component rendering for each
                  result
                </li>
                <li>
                  <strong>Grouped Results</strong> - Organize results by category with custom group
                  headers
                </li>
              </ul>
            </div>

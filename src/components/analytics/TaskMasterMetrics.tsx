  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Understanding task relationships and potential blockers</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="text-center py-12">
          ...
          <p className="text-sm text-muted-foreground">
            This will show task relationships, critical paths, and identify potential bottlenecks in
            your workflow.
          </p>
        </div>
      </CardContent>

  ...
  return (
    <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Context Builder</h1>
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <span className="ml-2 text-gray-900 dark:text-white">28.5</span>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <span className="ml-2 text-gray-900 dark:text-white">28.2 (In Progress)</span>
                    </div>
                    <div>
                      <span className="font-medium text-gray-700 dark:text-gray-300">
                        Estimated:
                      </span>
                      <span className="ml-2 text-gray-900 dark:text-white">4 subtasks</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={idx} className="flex items-center gap-3">
                      ...
                      <span className="text-sm text-gray-700 dark:text-gray-300">{constraint}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="space-y-6">
                  ...
                  <div
                    ...
                    className={`p-3 rounded border cursor-pointer transition-colors ${
                      template.selected
                        ...
                        : 'bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-800 hover:bg-gray-100'
                    }`}
                  >
                    <div className="flex items-center gap-2">
                      <input
            ...
            <div className="bg-white dark:bg-gray-950 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 p-4">
              ...
              <div className="space-y-3">
                ...
                <div className="p-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg opacity-75">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-6 h-6 bg-purple-500 rounded-full flex items-center justify-center">
                      <span className="text-white text-xs font-bold">Cu</span>
                    </div>
                    <span className="font-medium text-gray-700 dark:text-gray-300">Cursor</span>
                  </div>
                  <p className="text-xs text-gray-600 dark:text-gray-400">
                    Good for database-heavy implementations
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-950 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 p-4">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center justify-between">
                  <span className="text-gray-600 dark:text-gray-400">Files included:</span>
                  <span className="font-medium text-gray-900 dark:text-white">6</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600 dark:text-gray-400">Context size:</span>
                  <span className="font-medium text-gray-900 dark:text-white">~8.2K tokens</span>
                </div>
                <div className="flex items-center justify-between">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full px-4 py-3 border border-gray-300 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-900">
                Preview Context
              </button>
              <button className="w-full px-4 py-3 border border-gray-300 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-900">
                Save as Template

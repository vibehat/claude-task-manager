  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">AI Handoff Flow</h1>
        <p className="text-gray-600 mb-8">Task 28.5: RBAC System Implementation</p>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-900">Task Selection</p>
                <p className="text-xs text-gray-600">Task 28.5 selected</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-900">Context Building</p>
                <p className="text-xs text-gray-600">6 files, 8.2K tokens</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Select AI Agent</h2>
            ...
            <div className="space-y-4">
              ...
              {/* Cursor */}
              <div className="p-4 border border-gray-200 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3 flex items-center justify-between">
                      <span className="text-xs text-gray-600">Match score: 78%</span>
              ...
              <div className="p-4 border border-gray-200 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900 mb-2">GitHub Copilot</h3>
                    <p className="text-sm text-gray-700 mb-3">
                    ...
                    <div className="mt-3 flex items-center justify-between">
                      <span className="text-xs text-gray-600">Match score: 65%</span>
                      <input type="radio" name="agent" value="copilot" className="text-gray-600" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Handoff Configuration</h2>

            {/* Handoff Method */}
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-3">Handoff Method</label>
              <div className="space-y-3">
                ...
                <div className="flex items-center">
                  ...
                  <label className="ml-3 text-sm text-gray-900">
                    File-based Handoff
                    <p className="text-xs text-gray-600">Save context to .claude-context.md</p>
                  </label>
                </div>
            ...
            <div className="mb-6 p-4 bg-gray-50 rounded-lg">
              <h4 className="text-sm font-medium text-gray-900 mb-3">Context to Transfer</h4>
              <div className="space-y-2 text-sm">
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Task description & acceptance criteria</span>
                  <span className="text-green-600">✓</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Project context & conventions</span>
                  <span className="text-green-600">✓</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Related files (6 files)</span>
                  <span className="text-green-600">✓</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Implementation constraints</span>
                  <span className="text-green-600">✓</span>
                </div>
              </div>
            </div>

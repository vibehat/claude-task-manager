...
import { cliExecutor, CLIExecutionResult } from './cli-executor';
import { getGlobalWebSocketServer } from './websocket-server';
import { TasksData, Task, TaskStatus } from './types';
...
export class TaskMasterSyncManager extends EventEmitter {
   ...
   private wsServer = getGlobalWebSocketServer();
   ...
   private setupEventHandlers(): void {
      ...
      this.wsServer.on('clientConnected', async () => {
